...
export default function UpdateForm({ project }) {
    ...
    return (
        <div className="bg-white shadow rounded-lg p-6 mt-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Project Update</h3>
            
            <form onSubmit={submit} className="space-y-5">
                <div>
                    <InputLabel htmlFor="progress_percentage" value="Progress Percentage" />
                ...
                <div>
                    <InputLabel htmlFor="progress_description" value="Progress Description" />
                    <textarea
                ...
                <div>
                    <InputLabel htmlFor="milestones_completed" value="Milestones Completed (Optional)" />
                    <textarea
                ...
                <div>
                    <InputLabel htmlFor="challenges_faced" value="Challenges Faced (Optional)" />
                    <textarea
                        id="challenges_faced"
                ...
                <div>
                    <InputLabel htmlFor="resources_needed" value="Resources Needed (Optional)" />
                    <textarea
                        id="resources_needed"
