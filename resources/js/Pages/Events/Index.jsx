        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="mb-6 flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <Link href={route('events.create')} className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                Create Event
              </Link>
              <Link href={route('events.my-events')} className="px-4 py-2 border border-indigo-500 text-indigo-500 rounded-md hover:bg-indigo-50">
                My Events
              </Link>
            </div>
          </div>
